...
pub use generated::{
    ADMIN_SPEC_TITLE, ADMIN_SPEC_VERSION, BUILD_DATE, EMBEDDED_SPEC_CANONICAL_SHA256,
    EMBEDDED_SPEC_SHA256, GIT_SHA, REGISTRY, SPEC_TITLE, SPEC_URL, SPEC_VERSION, TARGET,
};
